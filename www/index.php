...
class wordpress_Main {
	public function __construct(){}
	static function main() {
	}
	function __toString() { return 'wordpress.Main'; }
}


class wordpress_example_PluginTest {
	public function __construct(){}
	static function addCss() {
	}
	function __toString() { return 'wordpress.example.PluginTest'; }
}
{
	$fn = array(new _hx_lambda(array(), "wordpress_example_PluginTest_0"), 'execute');
	add_action("admin_head", $fn);
}
function wordpress_example_PluginTest_0() {
	{
		$clsRef = Type::resolveClass("wordpress.example.PluginTest");
		Reflect::callMethod($clsRef, (isset(wordpress_example_PluginTest::$addCss) ? wordpress_example_PluginTest::$addCss: array("wordpress_example_PluginTest", "addCss")), (new _hx_array(array())));
	}
}
